(function($){
	...
	$( document ).ready(function() {
		...
		//Owl Animation
		$('.quint-animated').appear(function() {
			var elem = $(this);
			var animation = elem.data('animation');
			var delay = elem.data('animation-delay');
			if (!elem.hasClass('visible')) {
		...
		$( ".animated-owl-carousel" ).each(function() {
			...
			c_carousel.on('change.owl.carousel', function(event) {
				var animationDelay = $(event.target).find('.quint-animated').data('animation-duration');
				
				$(event.target).find('.quint-animated').each(function() {
