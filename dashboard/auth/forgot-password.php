                    ...
                    <form method="post">
                        <div class="panel panel-body login-form">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Recover Password <i class="icon-circle-right2 position-right"></i></button> <br >
                                <a class="btn btn-default btn-block" href="<?php echo $site->url; ?>/dashboard/auth/login">Cancel</a>
                            </div>
